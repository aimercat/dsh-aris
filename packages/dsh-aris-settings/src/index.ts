/**
 * Host half of dsh-aris-settings. Mounts the rc.6 compatibility settings
 * bridge: a loopback-only HTTP pair that serves the dsh-aris family plugins'
...
export function apply(ctx: Context): void {
  ctx.inject(['settings'], (sctx) => {
    ...
    }, 'dsh-aris-settings: settings bridge')
  })
}
