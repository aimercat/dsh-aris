...
export const zh = {
  ...
  'live2d.description': '总开关、语音与默认显示行为。',
  'live2d.enabled': '启用 Live2D',
  'live2d.enabledHint': '总开关。关闭后会完全移除爱丽丝 Live2D、折叠 launcher 与相关运行时功能。',
  'live2d.muted': '默认静音',
...
export const en = {
  ...
  'live2d.description': 'Master switch, voice, and default display behavior.',
  'live2d.enabled': 'Enable Live2D',
  'live2d.enabledHint': 'Master switch. When off, Aris Live2D, the collapsed launcher, and related runtime behavior are removed completely.',
